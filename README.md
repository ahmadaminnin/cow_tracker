...
Cow tracking implemented with YOLOv4, SORT, and TensorFlow. This study is copied from https://github.com/theAIGuysCode/yolov4-deepsort and modified to be applicable for tracking herd of cows, suitable with their behaviour. In consideration of high-speed processing, the appearance features used in DeepSORT are removed.
